...
public class level_one extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String ans = eg.generator_method(1,tv);
        Log.d("lol",String.valueOf(ans));
            ...
            public void onClick(View view) {
                if(count==0) {
                    ...
                    if (Integer.parseInt(ans)!=Integer.parseInt(value1)) {
                        Toast.makeText(level_one.this,"Wrong",Toast.LENGTH_LONG).show();
                        et.setText("");
                    } else {
                        count++;
                        Toast.makeText(level_one.this,"Correct",Toast.LENGTH_LONG).show();
                        equation_generator eg1 = new equation_generator();
                        ans1 = eg1.generator_method(1,tv);
                        et.setText("");
                    }
                }
                else if(count<5) {
                ...
                if(count==5) {
                    ...
                    Intent i =  new Intent(level_one.this,level_second.class);
                    startActivity(i);
                }
            }
    ...
    private class ProgressTask extends AsyncTask<Integer,Integer,Void>{
        ...
        protected void onPostExecute(Void result) {
            AlertDialog alertDialog = new AlertDialog.Builder(level_one.this).create();
            TextView title = new TextView(level_one.this);
